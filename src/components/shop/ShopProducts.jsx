        ...
        <div className="col-span-12">
          ...
          <div className="bg-[#f2f4f5] flex flex-wrap items-center md:justify-between gap-3 py-3 px-6 mt-4 mb-6">
            ...
            <div className="flex flex-wrap items-center gap-1">
              <p className="text-sm text-[#212529] font-semibold">65,867</p>
              <p className="text-sm text-[#6c757d]">Results found.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-12 gap-4">
            {products.map((product) => (
              ...
              >
                ...
                {product.badge && (
                  <p
                    className={`absolute top-3 left-3 py-[5px] px-2.5 text-white bg-[#EE5858] text-[12px] leading-4 font-semibold rounded-[3px] uppercase
                                                            ${
                                                              product.badge ===
                                                              "SOLD OUT"
                                                                ? "bg-[#929FA5]!"
