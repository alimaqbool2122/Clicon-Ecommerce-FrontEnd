    ...
    <>
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DialogContent
          ...
          className={
            "w-[calc(100%-2rem)] sm:w-[calc(100%-3rem)] md:w-[calc(100%-4rem)] xl:max-w-7xl 2xl:max-w-350 rounded-sm"
          }
        >
          {/* Dialog */}
          <DialogClose className="absolute -top-14 right-0 2xl:top-0 2xl:-right-17 w-10 h-10 2xl:w-12 2xl:h-12 bg-[#2E3137]/90 cursor-pointer flex items-center justify-center rounded-full z-60">
            <Image
          ...
          {/* Dialog Content */}
          <div className="h-[75vh] 2xl:h-[90vh] p-4 md:p-5 lg:p-6 xl:p-8 2xl:p-10 overflow-y-auto overflow-x-hidden custom-scrollbar-width">
            <motion.div
              initial={{ opacity: 0, y: 30, scale: 0.98 }}
              animate={{ opacity: 1, y: 0, scale: 1 }}
              transition={{ duration: 0.4, ease: "easeOut" }}
              className="grid grid-cols-12 lg:gap-14"
            >
              {/* Product Image Section */}
              <div className="col-span-12 xl:col-span-6 flex flex-col gap-4 sm:gap-6 mb-7.5">
                {/* Main Image */}
