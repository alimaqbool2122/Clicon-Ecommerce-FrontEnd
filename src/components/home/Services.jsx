...
const Services = () => (
  <div className="container">
    <div className="py-4 border border-[#E4E7E9] rounded-md grid gap-y-6 grid-cols-[auto] justify-center sm:grid-cols-[auto_auto] sm:justify-around lg:grid-cols-[auto_auto_auto_auto]">
      {homepageContent.featured.map((item, index) => (
        <div key={index} className="relative">
          <div
            className={`flex items-center ${index % 4 !== 0 ? "xl:before:content-[''] xl:before:absolute xl:before:left-[-40px] xl:before:top-1/2 xl:before:-translate-y-1/2 xl:before:w-px xl:before:h-14 xl:before:bg-[#E4E7E9]" : ""}`}
          >
