                ...
                {featureproduct.map((deals, index) => (
                  ...
                  >
                    ...
                    <div className="mb-6 card-data px-5">
                      ...
                      <Link
                        href="#"
                        className="text-[16px] text-[#191C1F] leading-6 font-normal pt-1.5 pb-3 line-clamp-2 duration-400 ease-linear hover:text-[#2DA5F3]"
                      >
                        {deals.title}
                      </Link>
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        className="group/icon relative w-12 h-12 bg-[#FFE7D6] grid place-content-center rounded-[3px] border-2 cursor-pointer border-[#FFE7D6] duration-300 hover:border-[#FA8232] hover:text-[#FA8232] tooltip"
                      ...
                      <button className="group/icon relative flex items-center gap-2 border-2 border-[#FA8232] bg-[#FA8232] cursor-pointer text-white h-12 px-[22.4px] text-[14px] leading-px uppercase font-bold rounded-[3px] duration-500 ease-linear hover:bg-transparent hover:text-[#191C1F]">
                        <Image
                      ...
                      <button
                        className="group/icon relative w-12 h-12 bg-[#FFE7D6] grid place-content-center rounded-[3px] mr-2 border-2 cursor-pointer border-[#FFE7D6] duration-300 hover:border-[#FA8232] hover:text-[#FA8232]"
