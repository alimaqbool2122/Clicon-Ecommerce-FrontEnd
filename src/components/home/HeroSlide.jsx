  ...
  return (
    <div className="bg-[#F2F4F5] rounded-md py-12.75 px-5 relative sm:py-15 sm:px-14 lg:grid lg:grid-cols-2 lg:items-center gap-8 xl:flex xl:flex-row-reverse">
      ...
      <div className="xl:w-full ">
        ...
        <h2 className="text-[32px] text-[#191C1F] font-semibold leading-[1.16] mb-4 md:text-[42px] lg:text-[48px] line-clamp-1">
          {slide.title}
        </h2>
        <p className="text-base text-[#495057] leading-[1.33] mb-3.5 md:text-lg xl:mb-6 line-clamp-3">
          {slide.description}
        </p>
