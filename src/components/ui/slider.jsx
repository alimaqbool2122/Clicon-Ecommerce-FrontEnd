...
function SliderThumb({ className, ...props }) {
  return (
    <SliderPrimitive.Thumb
      ...
      className={cn(
        "box-content block size-3 shrink-0 cursor-pointer rounded-full border-[2.4px] border-[#FA8232] bg-white shadow-xs shadow-black/5 outline-hidden focus:outline-hidden",
        className,
      )}
      {...props}
    />
